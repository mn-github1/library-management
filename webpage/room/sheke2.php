...
if(isset($_POST['submit'])){
	...
	$_SESSION['room']="sheke2";		//教室的数据库表名
	$_SESSION['room_name'] = "社会科学(2)";//教室的名字
...
<div class = "head_index">
	...
	<div class = "zwxz">
		...
		<a href="../lcxz_two.php">二楼</a> &gt; <a href="sheke2.php">社会科学(2)</a>
	</div>
	...
	<div class = "zw_start">
		...
		<div >
			<?php if ($arr[1]['state'] == '0') { ?>
				<input class = "zw" type = "submit" name = "submit" value = "2" />
			<?php }else { ?>
		...
		<div >
			<?php if ($arr[27]['state'] == '0') { ?>
				<input class = "zw" type = "submit" name = "submit" value = "28" />
			<?php }else { ?>
				<input class = "zw_y" type = "submit" name = "submit" value = "28" />
			<?php } ?>
		</div>
		<div class = "clear"> </div>
		<div >
