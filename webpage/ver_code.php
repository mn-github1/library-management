...
功能：生成验证码
*/
function vercode($width=120,$height=40,$fontSize=30,$countElement=5,$countPixel=100,$countLine=4){
	...
	imagettftext($img,$fontSize,rand(-5,5),rand(5,15),rand(30,35),$colorString, __DIR__.'/font/ManyGifts.ttf',$string);
	imagejpeg($img);
	imagedestroy($img);
